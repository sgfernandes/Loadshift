...
#china_DR_days <- purrr::map(.x = china_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T11:00/T18:00")
DC_DR_days <- purrr::map(.x = DC_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T11:00/T18:00")
FC_DR_days <- purrr::map(.x = FC_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T11:00/T18:00")
seattle_DR_days <- purrr::map(.x = seattle_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T11:00/T18:00")
vermont_DR_days <- purrr::map(.x = vermont_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T11:00/T18:00")
...
#china_cleaned_eload <- purrr::map(.x = china_completed_timeseries, .f = clean_eload_data, event_hours = "T11:00/T18:00")
DC_cleaned_eload <- purrr::map(.x = DC_completed_timeseries, .f = clean_eload_data, event_hours = "T11:00/T18:00")
FC_cleaned_eload <- purrr::map(.x = FC_completed_timeseries, .f = clean_eload_data, event_hours = "T11:00/T18:00")
seattle_cleaned_eload <- purrr::map(.x = seattle_completed_timeseries, .f = clean_eload_data, event_hours = "T11:00/T18:00")
vermont_cleaned_eload <- purrr::map(.x = vermont_completed_timeseries, .f = clean_eload_data, event_hours = "T11:00/T18:00")
...
DC_day_matched_baseline_pre <- purrr::map2(.x = DC_DR_days, .y = DC_completed_timeseries, .f = safe_calculate_day_matching_adjusted_baseline, pre_adjustment_only = TRUE,
                                           initial_timslice = "T07:00/T22:00", event_hours = "T11:00/T18:00",
...
DC_TOWT_baseline_pre <- purrr::map2(.x = DC_DR_days, .y = DC_completed_tibble, .f = safe_calculate_TOWT_adjusted_baseline, baseline_days_count = 7, timescale_days = NULL, 
                                    pre_adjustment_only = TRUE, initial_timslice = "T07:00/T22:00", event_hours = "T11:00/T18:00",
                                    pre_adjustment_hours = "T07:00/T08:00", post_adjustment_hours = "T21:00/T22:00")
...
vermont_weather_matched_baseline_pre <- purrr::map2(.x = vermont_DR_days, .y = vermont_completed_timeseries, .f = safe_calculate_weather_matching_adjusted_baseline, pre_adjustment_only = TRUE,
                                                    initial_timslice = "T07:00/T22:00", event_hours = "T11:00/T18:00",
                                                    pre_adjustment_hours = "T07:00/T08:00", post_adjustment_hours = "T21:00/T22:00")
