...
#china_DR_days <- purrr::map(.x = china_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T13:00/T18:00")
DC_DR_days <- purrr::map(.x = DC_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T13:00/T18:00")
FC_DR_days <- purrr::map(.x = FC_completed_timeseries_last_365, .f = find_DR_prediction_days)
seattle_DR_days <- purrr::map(.x = seattle_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T13:00/T18:00")
vermont_DR_days <- purrr::map(.x = vermont_completed_timeseries_last_365, .f = find_DR_prediction_days, event_hours = "T13:00/T18:00")
...
#china_cleaned_eload <- purrr::map(.x = china_completed_timeseries, .f = clean_eload_data, event_hours = "T13:00/T18:00")
DC_cleaned_eload <- purrr::map(.x = DC_completed_timeseries, .f = clean_eload_data, event_hours = "T13:00/T18:00")
FC_cleaned_eload <- purrr::map(.x = FC_completed_timeseries, .f = clean_eload_data, event_hours = "T13:00/T18:00")
seattle_cleaned_eload <- purrr::map(.x = seattle_completed_timeseries, .f = clean_eload_data, event_hours = "T13:00/T18:00")
vermont_cleaned_eload <- purrr::map(.x = vermont_completed_timeseries, .f = clean_eload_data, event_hours = "T13:00/T18:00")
...
#                                               initial_timslice = "T09:00/T22:00", event_hours = "T13:00/T18:00",
...
#                                        pre_adjustment_only = TRUE, initial_timslice = "T09:00/T22:00", event_hours = "T13:00/T18:00",
#                                        pre_adjustment_hours = "T09:00/T10:00", post_adjustment_hours = "T21:00/T22:00")
...
write.xlsx(all_metrics, paste0(results_directory, "All Metrics_12-6.xlsx"))
